 ...
 */
export function fixtureSync<T extends Element>(template: string | number | boolean | string[] | number[] | Node | boolean[] | Node[] | import("lit-html").TemplateResult | import("lit-html").TemplateResult[], options?: FixtureOptions): T;
/**
 * Renders a string/TemplateResult and puts it in the DOM via a fixtureWrapper.
 ...
 */
export function fixture<T extends Element>(template: string | number | boolean | string[] | number[] | Node | boolean[] | Node[] | import("lit-html").TemplateResult | import("lit-html").TemplateResult[], options?: FixtureOptions): Promise<T>;
export type FixtureOptions = {
     ...
     * definition map
     */
    scopedElements?: import("@open-wc/scoped-elements/src/types").ScopedElementsMap;
};
