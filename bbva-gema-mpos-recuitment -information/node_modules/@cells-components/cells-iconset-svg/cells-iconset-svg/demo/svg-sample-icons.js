import '../cells-iconset-svg.js';

const templateDocumentContainer = document.createElement('template');
templateDocumentContainer.setAttribute('style', 'display: none;');
templateDocumentContainer.innerHTML = `<cells-iconset-svg name="svg-sample-icons" size="100">
<template>
  <svg>
    <defs>
    <g id="codepen">
...
document.head.appendChild(templateDocumentContainer.content);
