...
import styles from './bbva-button-default-styles.js';

export { bbvaButtonDefaultAmbient } from './bbva-button-default-ambient.js';
...
*/
export class BbvaButtonDefault extends CellsButton {
  static get is() {
  ...
  static get styles() {
    return [super.styles, styles, getComponentSharedStyles('bbva-button-default-shared-styles')];
  }
