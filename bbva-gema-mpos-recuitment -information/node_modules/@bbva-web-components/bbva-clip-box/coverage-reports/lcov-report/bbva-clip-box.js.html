...
<head>
    <title>Code coverage report for bbva-clip-box.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-clip-box.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { LitElement, html } from 'lit-element';
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.text &amp;&amp; this.icon &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.iconColor)</span> {
<span class="cstat-no" title="statement not covered" >      this._setIconColor(this.iconColor);</span>
    }
&nbsp;
    if (this.bgColor !== '') {
      // bgColor setted
...
&nbsp;
    if (this.custom &amp;&amp; this.bgColor2 !== '') {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (BbvaClipBox.isDefaultColor(this.bgColor2)) {
<span class="cstat-no" title="statement not covered" >        this._setBgColor(randomColors[this.bgColor2]);</span>
      } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  _s</span>etIconColor(color) {
<span class="cstat-no" title="statement not covered" >    this.style.color = color;</span>
  }
&nbsp;
  render() {
    return html`
      &lt;div id="content"&gt;
        ...
        ${this.text || !this._hasIconImage
          ...
          : ''}
        &lt;cells-icon
          aria-hidden="${this._computedIsAriaHidden ? 'true' : <span class="branch-1 cbranch-no" title="branch not covered" >'false'}</span>"
