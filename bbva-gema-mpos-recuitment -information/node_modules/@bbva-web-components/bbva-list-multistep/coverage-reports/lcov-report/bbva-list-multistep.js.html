...
<head>
    <title>Code coverage report for bbva-list-multistep.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-list-multistep.js</h1>
        <div class='clearfix'>
...
&nbsp;
  connectedCallback() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (super.connectedCallback) {
