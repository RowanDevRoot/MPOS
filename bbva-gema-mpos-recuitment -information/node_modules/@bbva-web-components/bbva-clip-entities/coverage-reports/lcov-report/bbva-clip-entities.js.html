...
<head>
    <title>Code coverage report for bbva-clip-entities.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-clip-entities.js</h1>
        <div class='clearfix'>
...
import * as entities from './bbva-clip-entities-logos.js';
import '@bbva-web-components/bbva-clip-box';
import styles from './bbva-clip-entities-styles.js';
&nbsp;
export { bbvaClipEntitiesAmbient } from './bbva-clip-entities-ambient.js';
&nbsp;
/**
...
*/
export class BbvaClipEntities extends LitElement {
  static get is() {
...
&nbsp;
  static get styles() {
    return [styles, getComponentSharedStyles('bbva-clip-entities-shared-styles')];
  }
&nbsp;
  render() {
    return html`
