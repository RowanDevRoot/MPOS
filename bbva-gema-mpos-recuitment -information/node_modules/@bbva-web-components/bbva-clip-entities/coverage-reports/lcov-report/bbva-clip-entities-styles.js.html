...
<head>
    <title>Code coverage report for bbva-clip-entities-styles.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-clip-entities-styles.js</h1>
        <div class='clearfix'>
...
&nbsp;
bbva-clip-box {
  --bbva-clip-box-bg-color: var(--bbva-clip-entities-clip-box-bg-color, var(--colorsPrimaryVariantDark, ${unsafeCSS(foundations.colors.primaryVariantDark)})); }
...
:host([entity='bankinter']) svg #forma2 {
  fill: var(--bbva-clip-entities-bankinter-forma2-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
...
:host([entity='bbva']) svg #forma3 {
  fill: var(--bbva-clip-entities-bbva-forma3-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
...
:host([entity='kutxa']) svg #forma2 {
  fill: var(--bbva-clip-entities-kutxa-forma2-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
...
:host([entity='santander']) svg #forma2 {
  fill: var(--bbva-clip-entities-santander-forma2-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
:host([variant='white']) bbva-clip-box {
  --bbva-clip-box-bg-color: var(--bbva-clip-entities-white-clip-box-bg-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)}));
  --bbva-clip-box-text-color: var(--bbva-clip-entities-white-clip-box-text-color, var(--colorsPrimaryVariantDark, ${unsafeCSS(foundations.colors.primaryVariantDark)})); }
&nbsp;
:host([variant='white']) svg #forma1 {
  fill: var(--bbva-clip-entities-white-bg-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
...
:host([variant='white']):host([entity='bbva']) svg #forma1 {
  fill: var(--bbva-clip-entities-white-bbva-forma1-color, var(--colorsSecondary100, ${unsafeCSS(foundations.colors.secondary100)})); }
&nbsp;
:host([variant='white']):host([entity='bbva']) svg #forma2 {
  fill: var(--bbva-clip-entities-white-bbva-forma2-color, var(--colorsPrimaryCoreLightened, ${unsafeCSS(foundations.colors.primaryCoreLightened)})); }
&nbsp;
