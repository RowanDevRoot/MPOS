...
<head>
    <title>Code coverage report for bbva-core-meta/src/BbvaCoreMeta.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">bbva-core-meta/src</a> BbvaCoreMeta.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  get value() {
    ...
    this._key = undefined;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (type &amp;&amp; key) {
