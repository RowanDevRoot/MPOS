...
<head>
    <title>Code coverage report for bbva-clip-product.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-clip-product.js</h1>
        <div class='clearfix'>
...
&nbsp;
  get _largeSize() {
    return (
      this.size === 'large' &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >      this.variant !== 'maximum' </span>&amp;&amp;
      (<span class="branch-2 cbranch-no" title="branch not covered" >this.item === 'card' </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >this.item === 'phone')</span>
    );
  }
&nbsp;
