...
<head>
    <title>Code coverage report for bbva-clip-card.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-clip-card.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { LitElement, html, svg } from 'lit-element';
...
&nbsp;
  ...
  get card() {
    return this.cardImage
      ? <span class="branch-0 cbranch-no" title="branch not covered" >html`</span>
          &lt;img
            src="${this.cardImage}"
            id="cardImage"
            class="image-card"
