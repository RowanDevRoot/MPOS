...
<head>
    <title>Code coverage report for bbva-list-bullet-styles.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bbva-list-bullet-styles.js</h1>
        <div class='clearfix'>
...
export default css`:host {
  ...
  position: relative;
  padding: 0 0 calc(((1 * var(--gridSpacerVariant, var(--gridSpacer, ${unsafeCSS(foundations.grid.spacer)}))) / 16) * 1em) calc(((3 * var(--gridSpacerVariant, var(--gridSpacer, ${unsafeCSS(foundations.grid.spacer)}))) / 16) * 1em);
...
`;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jun 29 2020 11:24:53 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
